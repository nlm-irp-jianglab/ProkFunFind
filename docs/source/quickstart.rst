...
.. Attention::
   ...
   We add pan-genome support and the command line is different from previous version.  
     ...
     1. To run the original command, please add "`rep`" after `prokfunfind.py`
...
************
  ...
  * On a completely assembled genome (for example the representative UHGG genome)
    ...
    ``prokfunfind.py rep -b data.folder -f Mucic_and_Saccharic_Acid -g input.folder/MGYG-HGUT-02439 -o output.prefix`` 
  ...
  * On preconfigure pangenome set 
    ...
    ``prokfunfind.py pan  -b ProkFunFind/data  -f Flagellar  -g UHGG/all_genomes/MGYG-HGUT-014/MGYG-HGUT-01463 -p UHGG/uhgg_catalogue/MGYG-HGUT-014/MGYG-HGUT-01463/pan-genome -d output.dir``
