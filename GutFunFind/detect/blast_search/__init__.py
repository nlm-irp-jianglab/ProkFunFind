...
def pipeline(config_file:Union[str, IO], protein_file:Union[str, IO], outprefix:str) -> List[QueryResult]:
    ...
    cmd = [ cf["blast.exec"], "-query",  protein_file, "-db" ,cf["blast.query"], "-evalue", cf["blast.evalue"], "-outfmt" ,"6", "-out", outprefix+".blast.m6"]
